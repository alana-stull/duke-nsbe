    ...
    <>
      ...
      <section className="bg-mist/50">
        <div className="mx-auto max-w-content px-6 py-24 md:py-32">
          ...
          <p className="mt-6 max-w-xl font-body text-lg leading-relaxed text-slate">
            Twelve students who run this chapter alongside a full course
            load. Reach out to any of them directly, or email the chapter
      ...
      <section>
        <div className="mx-auto max-w-content px-6 py-24 text-center md:py-32">
          ...
          <p className="mx-auto mt-6 max-w-xl font-body text-lg leading-relaxed text-slate">
            Come to a general body meeting. They&rsquo;re open to everyone,
            no invitation needed. From there, national membership is a
            short online registration plus GPA verification, which you can
            complete right here once you&rsquo;re signed in.
          </p>
          <Link
            href="/events"
